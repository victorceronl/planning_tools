...
ORIGEN_XLSX = r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\corte\corte.xlsx"

CARPETA_SCRIPT = Path(
    r"C:\Users\Diseño 1\Documents\REPORTE-PRODUCCION_v006"
)

DESTINO_XLSX = CARPETA_SCRIPT / "corte.xlsx"

SCRIPT_PYTHON = CARPETA_SCRIPT / "corte_CheckList.py"

HTML_GENERADO = CARPETA_SCRIPT / "corte-CheckList.html"

DESTINO_HTML_1 = (
    r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\CheckList\corte-CheckList.html"
)

DESTINO_HTML_2 = (
    r"C:\Users\Diseño 1\Documents\7.-Avance de producción\CheckList\corte-CheckList.html"
)
