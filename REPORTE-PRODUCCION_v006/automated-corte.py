...
SCRIPT_PYTHON = CARPETA_SCRIPT / "corte_estatus.py"

HTML_GENERADO = CARPETA_SCRIPT / "corte-estatus.html"

DESTINO_HTML_1 = (
    r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\CheckList\corte-estatus.html"
)

DESTINO_HTML_2 = (
    r"C:\Users\Diseño 1\Documents\7.-Avance de producción\CheckList\corte-estatus.html"
)
