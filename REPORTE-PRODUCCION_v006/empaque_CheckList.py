...
df_material = pd.read_excel(ARCHIVO_EMPAQUE, sheet_name="MATERIAL-CHECK")
...
for proyecto in sorted(proyectos.keys()):
    ...
    html += f'<details closed><summary>{proyecto}</summary><div class="card">'
