...
ORIGEN_XLSX = r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\liberacion\calidad.xlsx"

CARPETA_SCRIPT = Path(
    r"C:\Users\Diseño 1\Documents\REPORTE-PRODUCCION_v006"
)

DESTINO_XLSX = CARPETA_SCRIPT / "calidad.xlsx"

SCRIPT_PYTHON = CARPETA_SCRIPT / "calidad_CheckList.py"

HTML_GENERADO = CARPETA_SCRIPT / "calidad-CheckList.html"

DESTINO_HTML_1 = (
    r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\CheckList\calidad-CheckList.html"
)

DESTINO_HTML_2 = (
    r"C:\Users\Diseño 1\Documents\7.-Avance de producción\CheckList\calidad-CheckList.html"
)
...
INTERVALO_SEGUNDOS = 1 * 60     # 1 minuto
DURACION_HORAS = 8
