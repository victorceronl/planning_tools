...
ORIGEN_XLSX = r"C:\Users\Diseño 1\Documents\7.-Avance de producción\xls\proveedor.xlsx"

CARPETA_SCRIPT = Path(
    r"C:\Users\Diseño 1\Documents\REPORTE-PRODUCCION_v006"
)

DESTINO_XLSX = CARPETA_SCRIPT / "proveedor.xlsx"

SCRIPT_PYTHON = CARPETA_SCRIPT / "4-proveedor-Estatus.py"

HTML_GENERADO = CARPETA_SCRIPT / "proveedor-estatus.html"

DESTINO_HTML_1 = (
    r"\\192.168.1.2\Arbeit2\TMIP2026\7.-Avance de producción\CheckList\proveedor-estatus.html"
)

DESTINO_HTML_2 = (
    r"C:\Users\Diseño 1\Documents\7.-Avance de producción\CheckList\proveedor-estatus.html"
)
