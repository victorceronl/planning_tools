...
df_material = pd.read_excel(
    ARCHIVO_EMPAQUE,
    sheet_name="SALIDA-MATERIAL"
)

df_packing = pd.read_excel(
    ARCHIVO_EMPAQUE,
    sheet_name="ENTRADA-MATERIAL"
)
...
<h1>Dashboard Material / Packing Check</h1>
...
for proyecto in sorted(proyectos.keys()):
    ...
    <div class="card">
        ...
        <div class="kpi">
        <b>Material Check</b><br>
        {total_material}
        </div>

        <div class="kpi">
        <b>Packing Check</b><br>
        {total_packing}
        </div>
