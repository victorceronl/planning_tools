...
def corregir_texto(archivo_entrada="salida.txt", archivo_salida="salida_corregido.txt"):
    ...
    texto = re.sub(r"Page\s*\d+", "", texto, flags=re.I)  # Eliminar numeración de página
    ...
    reemplazos = {
        ...
        "A ́": "Á", "E ́": "É", "I ́": "Í", "O ́": "Ó", "U ́": "Ú",
        "n ̃": "ñ", "N ̃": "Ñ",
        "ı ́": "í", "I ́": "Í",  # << NUEVO: corrige casos de 'ı ́'
        "o ̈": "ö", "u ̈": "ü",
        "’": "'", "‘": "'", "“": '"', "”": '"',
        "´": "'", "–": "-", "—": "-",
    }
    ...
    # Normalizar combinaciones Unicode (acentos y tildes separadas)
